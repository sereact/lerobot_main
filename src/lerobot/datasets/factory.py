...
def make_dataset(
    ...
    Args:
        ...
        dataset_cfg (DatasetConfig | None): Optional dataset override. Defaults to `cfg.dataset`.
    ...
    if dataset_cfg is None:  # pragma: no cover
        raise ValueError("dataset_cfg must not be None")
