...
def process_suite(root, gpu_id, args):
...
if __name__ == "__main__":
    data_roots = ['/home/ubuntu/git/sereact/dataset_libero_raw/libero_spatial', '/home/ubuntu/git/sereact/dataset_libero_raw/libero_object', '/home/ubuntu/git/sereact/dataset_libero_raw/libero_goal']
    ...
    for gpu_id, root in enumerate(data_roots):
        p = Process(target=process_suite, args=(root, gpu_id, args))
        p.start()
        processes.append(p)
